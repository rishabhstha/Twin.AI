...
import { loginWithGoogle } from "./config/helpers/auth";
...
const loginButtonUrl ="https://firebasestorage.googleapis.com/v0/b/doppelganger-app1.appspot.com/o/google-icon-white.png?alt=media&token=1eb1dafb-443d-4abe-a29f-9a24ffbdefb3";
const styles = {
