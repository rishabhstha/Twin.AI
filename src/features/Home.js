      ...
      return (
        <div key={photo.id}>
          <div style={{ minHeight: "215px" }}>
            <i
              onClick={() => this.handleRemove(photo.id)}
              className="bottom-icon material-icons main-close"
            >
              close
            </i>
          ...
          <div className="scrolling-wrapper">{this.dopples}</div>
